...
function CurriculumAnalysis() {
  ...
  const cplByType = cplData?.cpls?.reduce((acc: any, cpl: any) => {
    let type = 'Lainnya';
  ...
  const mkBySemester = mataKuliahData?.allMataKuliah?.reduce((acc: any, mk: any) => {
